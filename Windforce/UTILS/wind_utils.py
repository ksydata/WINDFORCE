...
class WindUtils:
    """바람·대기 물리 계산을 모아둔 정적 메서드 전용 클래스.
...
compute_wind_speed = WindUtils.compute_wind_speed
compute_wind_direction = WindUtils.compute_wind_direction
compute_uv_component = WindUtils.compute_uv_component
compute_angle_difference = WindUtils.compute_angle_difference
compute_wind_shear = WindUtils.compute_wind_shear
calculate_air_density = WindUtils.calculate_air_density
calculate_wind_power_density = WindUtils.calculate_wind_power_density
transform_wind_direction = WindUtils.transform_wind_direction


__all__ = [
    "R_D", "EPSILON", "ONE_MINUS_EPS", "WindUtils",
